...
const SHOWCASE_ITEMS = [
  { id: 1, title: "MacBook Air M1", price: "Rs. 185,000", badge: "BRAND NEW", imageSrc: "/images/unimart/macbookM1.jpg", bg: "bg-sky-100", badgeColor: "bg-sky-100 text-sky-700" },
  { id: 2, title: "Engineering Math Vol 2", price: "Rs. 2,500", badge: "USED", imageSrc: "/images/unimart/EngineeringMath.jpg", bg: "bg-amber-100", badgeColor: "bg-amber-100 text-amber-700" },
  { id: 3, title: "Sony WH-1000XM4", price: "Rs. 65,000", badge: "LIKE NEW", imageSrc: "/images/unimart/SonyWH.jpg", bg: "bg-fuchsia-100", badgeColor: "bg-fuchsia-100 text-fuchsia-700" },
  { id: 4, title: "iPhone 13 Pro", price: "Rs. 210,000", badge: "MINT", imageSrc: "/images/unimart/iphone13 Pro.jpg", bg: "bg-emerald-100", badgeColor: "bg-emerald-100 text-emerald-700" },
  { id: 5, title: "Scientific Calculator", price: "Rs. 6,500", badge: "USED", imageSrc: "/images/unimart/scientific.jpg", bg: "bg-indigo-100", badgeColor: "bg-indigo-100 text-indigo-700" },
];
...
return (
    ...
    <div className={`${inter.className} relative pb-0 min-h-screen -mt-2 md:-mt-10`}>
      ...
      <section
  className="relative z-10 mb-12 w-[100vw] left-1/2 -ml-[50vw] bg-white/60 border-b border-white/80 shadow-[0_20px_50px_rgba(14,116,144,0.08)] backdrop-blur-2xl overflow-hidden min-h-[75vh] flex flex-col pt-2 pb-12 mt-0"
>
  {/* Background Image Layer */}
  <div 
    className="absolute inset-0 z-[-1] opacity-30 bg-cover bg-center bg-no-repeat" 
    style={{ backgroundImage: "url('/images/unimart/unimart_hero_BG.png')" }}
  ></div>
              ...
              <AnimatePresence mode="popLayout">
                {SHOWCASE_ITEMS.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`relative w-full h-28 ${item.bg} rounded-2xl mb-3 overflow-hidden`}>
                        <Image
                          src={item.imageSrc}
                          alt={item.title}
                          fill
