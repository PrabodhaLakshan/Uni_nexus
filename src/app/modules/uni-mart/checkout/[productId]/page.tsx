...
// // //           {/* Card 1: Why Shop with Us? */}
// // //           <div className="bg-gradient-to-br from-blue-500/15 to-purple-500/15 backdrop-blur-md rounded-2xl border border-blue-300/30 shadow-lg p-6">
// // //             <h3 className="font-bold text-gray-900 text-lg mb-4">Why Shop with Us?</h3>
...
// // //           {/* Card 2: Buyer Protection (NEW) */}
// // //           <div className="bg-emerald-50/80 backdrop-blur-md rounded-2xl border border-emerald-200 shadow-lg p-6">
// // //             <div className="flex items-center gap-2 mb-3">
// // //               <Shield className="text-emerald-600" size={24} />
// // //               <h3 className="font-bold text-gray-900 text-lg">Buyer Protection</h3>
// // //             </div>
...
// // //             </p>
// // //             <div className="flex items-center gap-2 text-emerald-700 text-sm font-semibold bg-emerald-100/50 p-2.5 rounded-lg">
...
// // //           <div className="bg-white/60 backdrop-blur-md rounded-2xl border border-white/40 shadow-lg p-6">
// // //             <div className="flex items-center gap-2 mb-4">
// // //               <ShieldCheck className="text-amber-500" size={24} />
// // //               <h3 className="font-bold text-gray-900 text-lg">Safe Handover Tips</h3>
// // //             </div>
// // //             <ul className="space-y-4">
// // //               <li className="flex gap-3 text-sm text-gray-700">
// // //                 <MapPin size={18} className="text-gray-400 flex-shrink-0 mt-0.5" />
// // //                 <span>Meet in well-lit, public campus areas like the main canteen or library lobby.</span>
// // //               </li>
// // //               <li className="flex gap-3 text-sm text-gray-700">
// // //                 <Eye size={18} className="text-gray-400 flex-shrink-0 mt-0.5" />
...
// // //                 <span>Bring a friend along if you are purchasing a high-value item.</span>
// // //               </li>
// // //             </ul>
// // //           </div>

// // //           {/* Card 4: Quick FAQs (NEW) */}
// // //           <div className="bg-white/60 backdrop-blur-md rounded-2xl border border-white/40 shadow-lg p-6">
// // //             <div className="flex items-center gap-2 mb-4">
// // //               <HelpCircle className="text-indigo-500" size={24} />
// // //               <h3 className="font-bold text-gray-900 text-lg">Quick FAQs</h3>
// // //             </div>
// // //             <div className="space-y-5">
// // //               <div>
// // //                 <h4 className="text-sm font-bold text-gray-900 flex items-center gap-2 mb-1">
// // //                   <Clock size={14} className="text-gray-500"/> How long does verification take?
// // //                 </h4>
// // //                 <p className="text-sm text-gray-600">Bank deposit receipts are typically verified within 1-2 hours during working days.</p>
// // //               </div>
// // //               <div>
// // //                 <h4 className="text-sm font-bold text-gray-900 flex items-center gap-2 mb-1">
// // //                   What if I cancel?
// // //                 </h4>
// // //                 <p className="text-sm text-gray-600">You can cancel the order anytime before the seller accepts the handover or ships the item for a full refund.</p>
// // //               </div>
// // //             </div>
// // //           </div>
...
// //   return (
// //     <div className={`relative min-h-screen pb-20 ${inter.className}`}>
...
//   return (
//     <div className={`relative min-h-screen pb-0 overflow-x-hidden flex flex-col ${inter.className}`}>
//       {/* Abstract Background Elements for Modern Look */}
//       <div className="fixed inset-0 pointer-events-none overflow-hidden -z-10">
//         <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-blue-400/10 blur-[120px]"></div>
//         <div className="absolute bottom-[20%] right-[-10%] w-[30%] h-[50%] rounded-full bg-purple-400/10 blur-[120px]"></div>
...
//       {/* Footer Component - Full Bleed Breakout with absolute screen width */}
//       <div className="relative w-[100vw] left-[50%] -translate-x-[50%] mt-12bg-white">
//         <Footer />
//       </div>
//     </div>
//   );
              ...
              <div className="mt-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                {paymentMethod === "BANK" && (
                  <BankDepositForm
                    onSubmit={handleBankDepositSubmit}
                    isProcessing={isProcessing}
                    sellerBankDetails={product.sellerBankDetails}
                  />
                )}
                {paymentMethod === "CARD" && (
                  <CardPaymentForm
