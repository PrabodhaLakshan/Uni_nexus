...
// //                       className={`rounded-2xl py-3.5 font-bold shadow-sm transition-all hover:-translate-y-0.5 flex items-center justify-center gap-2.5 ${
// //                         product.status !== "AVAILABLE"
...
// //                       className="rounded-2xl bg-yellow-300 py-3.5 font-bold text-slate-900 shadow-sm transition-all hover:-translate-y-0.5 hover:bg-yellow-400 disabled:bg-gray-200 disabled:text-gray-500 flex items-center justify-center gap-2.5"
// //                     >
...
// //                       className={`h-14 w-14 rounded-2xl border-2 transition-all hover:-translate-y-0.5 flex items-center justify-center ${
// //                         isFavorite
...
// //                       className="h-14 w-14 rounded-2xl border-2 border-gray-300 bg-gray-100 text-gray-600 transition-all hover:-translate-y-0.5 hover:border-gray-400 flex items-center justify-center"
// //                     >
// //                       <Share2 size={22} />
// //                     </button>
// //                   </div>
...
//                       }}
//                       disabled={product.status !== "AVAILABLE"}
//                       className={`group flex items-stretch overflow-hidden rounded-full border-2 shadow-sm transition-transform hover:-translate-y-0.5 ${
//                         product.status !== "AVAILABLE"
...
//                       }`}
//                     >
//                       <span className={`flex w-[72px] shrink-0 items-center justify-center rounded-r-[1.25rem] bg-white transition-colors ${
//                         product.status !== "AVAILABLE" ? "text-gray-400" : "text-violet-500 group-hover:text-violet-600"
//                       }`}>
//                         <ShoppingCart size={26} strokeWidth={2.5} />
//                       </span>
//                       <span className="flex flex-1 items-center justify-center px-4 py-3.5 text-lg font-extrabold uppercase tracking-wide text-white">
//                         Add to Cart
//                       </span>
//                     </button>
...
//                       }`}
//                     >
//                       <span className={`flex w-[60px] shrink-0 items-center justify-center rounded-r-[1.25rem] bg-white sm:w-[72px] transition-colors ${
//                         isStartingChat ? "text-gray-400" : "text-amber-500 group-hover:text-amber-600"
//                       }`}>
//                         <MessageCircle size={24} strokeWidth={2.5} />
//                       </span>
//                       <span className="flex flex-1 items-center justify-center px-2 py-3.5 text-[13px] font-extrabold uppercase tracking-wide text-white sm:text-[15px]">
...
//                       onClick={() => setIsFavorite(!isFavorite)}
//                       aria-label="Toggle favorite"
//                       className={`h-[56px] w-[56px] rounded-2xl border-2 transition-all hover:-translate-y-0.5 flex items-center justify-center ${
//                         isFavorite
//                           ? "border-red-500 bg-red-50 text-red-500"
//                           : "border-gray-300 bg-gray-100 text-gray-600 hover:border-gray-400"
//                       }`}
...
//                     <button
//                       aria-label="Share product"
//                       className="h-[56px] w-[56px] rounded-2xl border-2 border-gray-300 bg-gray-100 text-gray-600 transition-all hover:-translate-y-0.5 hover:border-gray-400 flex items-center justify-center"
//                     >
//                       <Share2 size={22} />
//                     </button>
//                   </div>
