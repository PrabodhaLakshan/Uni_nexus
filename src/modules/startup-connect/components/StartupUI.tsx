...
import { UserCircle, Building2, Briefcase, ArrowRight, Home } from "lucide-react";

export const StartupUI = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="p-8 max-w-6xl mx-auto mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          {/* Student Card - මෙතන තමයි ඔයා ඉල්ලපු Link එක තියෙන්නේ */}
          ...
          <Card className="group relative overflow-hidden border border-gray-100 shadow-xl shadow-gray-50/50 hover:border-orange-200 hover:shadow-orange-50 transition-all duration-300 rounded-3xl">
            ...
            <CardContent className="pb-12 pt-6">
              <Link href="/startup-connect/create-startup-profile">
                <Button className="w-full bg-orange-600 hover:bg-orange-700 text-white font-semibold py-6 rounded-xl group flex items-center justify-center gap-2">
